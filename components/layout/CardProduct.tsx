...
import { FaCartPlus, FaCreditCard, FaMoneyBill } from "react-icons/fa6";
...
export default function CardProduct({ className }: CardProductProps) {
  return (
    <Link className="h-full w-full" href="/">
      <div
        className={`${className} flex h-full min-w-[270px] flex-col gap-2 rounded-xl bg-white p-2 text-zinc-800`}
      >
